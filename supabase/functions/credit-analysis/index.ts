// Tipos mínimos do Deno para Supabase Edge Functions (runtime reconhece o global Deno)
declare const Deno: {
  env: { get(key: string): string | undefined };
  serve: (handler: (req: Request) => Promise<Response>) => void;
};

// Usa Deno.serve() nativo (recomendado pelo Supabase) - evita import remoto no bundle
const corsHeaders = {
